...
int main(void)
{
    ...
    RTOS_ASSERT(rtos_scheduler_add_task(&ta)); RTOS_ASSERT(rtos_scheduler_add_task(&tb));
    RTOS_ASSERT(rtos_scheduler_add_task(&tc)); RTOS_ASSERT(rtos_scheduler_add_task(&ti));
