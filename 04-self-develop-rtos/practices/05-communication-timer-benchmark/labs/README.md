...
cd ../06-timer-service-task
make

cd ../07-timestamp-backends
make

cd ../08-context-switch-benchmark
make

cd ../09-event-message-latency
make

cd ../10-target-communication-benchmark-console
make
```
